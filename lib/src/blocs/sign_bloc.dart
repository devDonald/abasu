...
class SignBloc {
  ...
  Stream<int> get experience =>
      _experience.stream.transform(validateExperience);
  ...
  Stream<bool> get isValid => CombineLatestStream.combine9(
      ...
      gender,
      phone,
      (email, password, fullName, city, address, state, country, gender,
              phone) =>
          true);
  ...
  signupEmail() async {
    try {
      ...
      var user = UsersModel(
          ...
          country: _city.value,
          state: _country.value,
          gender: _country.value,
