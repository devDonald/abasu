...
class AuthBloc {
  ...
  //Function(bool) get type => _password.sink.add;
  ...
  //Functions
  signupEmail(bool userType) async{
    try{
      ...
      var user = ApplicationUser(userId: authResult.user.uid, email: _email.value.trim(),asArtisan: userType);
