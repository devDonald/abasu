...
import 'package:abasu/src/widgets/alerts.dart';
import 'package:abasu/src/widgets/button.dart';
import 'package:abasu/src/widgets/social_button.dart';
import 'package:abasu/src/widgets/textfield.dart';
...
class Signup extends StatefulWidget{
  ...
  Signup({Key key, this.asArtisan}):super(key:key);
...
class _SignupState extends State<Signup> {
  ...
  void initState() {
    ...
    _userSubscription = authBloc.user.listen((user) {
      if (user != null)  Navigator.pushNamedAndRemoveUntil(
                ...
                TextSpan(  
                  ...
                  recognizer: TapGestureRecognizer()
                      ..onTap = () => Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  Login(asArtisan: widget.asArtisan,)
                          ))
                )
              ]
            )
