...
class ViewArtisanWorks extends StatefulWidget {
  final String userId, name;
  ViewArtisanWorks({Key key, this.userId, this.name}) : super(key: key);

  @override
  _ViewArtisanWorksState createState() => _ViewArtisanWorksState();
}

class _ViewArtisanWorksState extends State<ViewArtisanWorks> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('${widget.name}\'s Works',
            style: TextStyle(
              color: Colors.white,
              fontSize: 18.0,
