...
class ArtisanReviews extends StatefulWidget {
  final String userId;
  final String userName, photo;
  ArtisanReviews({Key key, this.userId, this.userName, this.photo})
      : super(key: key);

  @override
  _ArtisanReviewsState createState() => _ArtisanReviewsState();
}

class _ArtisanReviewsState extends State<ArtisanReviews> {
...
class ReviewMessageBox extends StatelessWidget {
  ReviewMessageBox({
    Key key,
    this.senderName,
    this.senderPhoto,
...
class CommentDialog extends StatefulWidget {
  final String userName, userId, senderName, senderPhoto, senderId, photo;
              ...
              PrimaryButton(
                  ...
                  onTap: () async {
                    if (_message.text != '') {
                      ...
                      DocumentReference _docRef = await usersRef
                          .doc(widget.userId)
                          .collection('reviews')
                          .doc();
                      _docRef.set({
                        ...
                        if (widget.senderId != widget.userId) {
                          await activityFeedRef.doc(_docRef.id).set({
                            'senderId': widget.senderId,
                            'senderName': widget.senderName,
                            'review': _message.text,
                            'type': 'review',
